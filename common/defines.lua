...
NDiplomacy = {
	...
	OFFER_VASSALIZATION_INTERACTION_THRESHOLD_FOR_NO = 25000,
	...
	CALL_ALLY_INTERACTION_THRESHOLD_FOR_YES = 85,
...
NCharacter = {
	...
	FERTILITY_BASE_MULT = 0.40,						-- Base fertility multiplier to adjust the base chance of impregnation
...
NMilitary = {
	...
	LOOT_TAX_MULTIPLIER = 1,						-- Base gold looted from raided holdings is (tax * LOOT_TAX_MULTIPLIER) + (total building value * LOOT_BUILDING_MULTIPLIER)
	...
	PIKEMEN_PHASE_MELEE_DEFENSE = 5,
	PIKEMEN_PHASE_PURSUE_DEFENSE = 0.1,
	...
	LIGHT_CAVALRY_PHASE_SKIRMISH_DEFENSE = 3.5,
	...
	KNIGHTS_PHASE_SKIRMISH_DEFENSE = 5,
	...
	ARCHERS_PHASE_SKIRMISH_DEFENSE = 4,
	ARCHERS_PHASE_MELEE_DEFENSE = 0.5,
...
NTechnology = {
	DONT_EXECUTE_TECH_BEFORE = 271,				-- Set this to your earliest starting year
...
NEngine = {
	EVENT_PROCESS_OFFSET = 100, 	 -- Events are checked every X day per character or province (1 is ideal, but CPU heavy). Max value of 255
